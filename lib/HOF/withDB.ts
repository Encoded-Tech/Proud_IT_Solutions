...
//   options: WithDBOptions = {}
// ): RouteHandler {
//   const wrapped: RouteHandler = async (req: NextRequestWithResourceName, context?: ContextWithParams) => {
//     // 1️⃣ Connect to database
//     await connectDB();
...
//     // 3️⃣ Always call handler with both arguments (context may be undefined)
//     return handler(req, context);
//   };

//   // 4️⃣ Wrap in error handler
//   return errorHandler(wrapped, options) as RouteHandler;
// }