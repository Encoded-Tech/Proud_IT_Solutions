...
const HeroBanners = ({ banners }: HeroBannersProps) => {
  ...
  return (
    <section className="w-full">
      {/*
        aspect-[1025/576] = your exact image ratio.
        object-cover fills the container edge-to-edge with NO whitespace and NO cropping
        because the container shape already matches the image shape perfectly.
      */}
      <div className="relative w-full aspect-[1025/576] rounded-xl overflow-hidden shadow-2xl">
        ...
        {banners.length > 1 && (
          <>
            ...
            >
              <svg className="w-5 h-5 sm:w-6 sm:h-6 text-slate-900 group-hover:-translate-x-0.5 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={2.5}>
